...
### Medium value comparisons

```{r}
country_medium_view_value_per_medium <- read_csv(
  path_join(c(here(), data_dir, "country_medium_view_value_per_medium.csv"))
)
...
### High volume free traffic that converts well
...
### Good conversion rate and high value
